...
pub type SceneGraphStoragesMut<'a> =
    crate::views::SceneGraphStoragesMut<'a, Vec3, Quat, Matrix4, f32>;
...
pub type LocalTransform = crate::components::LocalTransform<Matrix4, f32>;
pub type WorldTransform = crate::components::WorldTransform<Matrix4, f32>;

//Systems
pub fn local_transform_sys(
    trs_storages_mut: LocalTransformStoragesMut<Vec3, Quat, Matrix4, f32>,
...
pub fn init_scenegraph(world: &World) -> EntityId {
    crate::init::init_scenegraph::<Vec3, Quat, Matrix4, f32>(world)
}
